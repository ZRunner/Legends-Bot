...
class TimeCog(commands.Cog):
    ...
    async def time_delta(self,date1,date2,year=False,hour=True,digital=False,precision=2):
        ...
        if type(date) == datetime.datetime:
            ...
            if digital:
                ...
                if lang == 'en':
                    ...
                    df = "{d} {m} {y}  {h}"
                df = df.format(d=jour,m=months[date.month-1],y=str(date.year) if year else "",h=":".join(h) if hour else "")
            return df
